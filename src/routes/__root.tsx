...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "theme-color", content: "#3D5F92" },
      { title: "50Milimetros — Fotografías oficiales de porrismo y cheerleading" },
      { property: "og:title", content: "50Milimetros — Fotografías oficiales de porrismo y cheerleading" },
      { name: "twitter:title", content: "50Milimetros — Fotografías oficiales de porrismo y cheerleading" },
